...
public partial class GameEntity {
    ...
    public RimuruDev.Code.Gameplay.Features.Hero.HeroAnimatorComponent heroAnimator { get { return (RimuruDev.Code.Gameplay.Features.Hero.HeroAnimatorComponent)GetComponent(GameComponentsLookup.HeroAnimator); } }
    ...
    public GameEntity AddHeroAnimator(Code.Gameplay.Features.Hero.Behaviours.HeroAnimator newValue) {
        ...
        var component = (RimuruDev.Code.Gameplay.Features.Hero.HeroAnimatorComponent)CreateComponent(index, typeof(RimuruDev.Code.Gameplay.Features.Hero.HeroAnimatorComponent));

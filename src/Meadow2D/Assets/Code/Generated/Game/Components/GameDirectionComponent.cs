...
public partial class GameEntity {
    ...
    public RimuruDev.Code.Gameplay.Features.Movement.Direction direction { get { return (RimuruDev.Code.Gameplay.Features.Movement.Direction)GetComponent(GameComponentsLookup.Direction); } }
    ...
    public GameEntity AddDirection(UnityEngine.Vector2 newValue) {
        ...
        var component = (RimuruDev.Code.Gameplay.Features.Movement.Direction)CreateComponent(index, typeof(RimuruDev.Code.Gameplay.Features.Movement.Direction));

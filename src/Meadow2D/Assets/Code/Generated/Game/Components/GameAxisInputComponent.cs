...
public partial class GameEntity {
    ...
    public RimuruDev.Code.Gameplay.Input.AxisInput axisInput { get { return (RimuruDev.Code.Gameplay.Input.AxisInput)GetComponent(GameComponentsLookup.AxisInput); } }
    ...
    public GameEntity AddAxisInput(UnityEngine.Vector2 newValue) {
        ...
        var component = (RimuruDev.Code.Gameplay.Input.AxisInput)CreateComponent(index, typeof(RimuruDev.Code.Gameplay.Input.AxisInput));

...
public partial class GameEntity {
    ...
    public RimuruDev.Code.Gameplay.Features.Movement.Speed speed { get { return (RimuruDev.Code.Gameplay.Features.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (RimuruDev.Code.Gameplay.Features.Movement.Speed)CreateComponent(index, typeof(RimuruDev.Code.Gameplay.Features.Movement.Speed));
